...
const skills = [
  "Configure Azure Active Directory and manage users",
  "Implement role-based access control",
  "Manage subscriptions and governance",
  "Deploy and manage virtual machines",
  "Create and manage containers",
  "Deploy applications using Docker and Kubernetes",
  "Implement DevOps practices and use Azure Boards"
];
...
const reviews = [
  {
    name: "Learner",
    date: "July 2, 2026",
    course: "Microsoft Azure Administrator Training (AZ-104)",
    text: "This course provided a solid understanding of Microsoft Azure administration. The content was well organized and covered key topics such as Azure Virtual Machines, Virtual Networks (VNets), Azure Storage, Azure Active Directory (Microsoft Entra ID), Resource Groups, Load Balancers, Network Security Groups (NSGs), Azure Monitor, Backup and Recovery, and identity and access management. The explanations were clear, and the hands-on labs made it easier..."
  },
  {
    name: "Michael",
    date: "June 15, 2026",
    course: "Azure DevOps: Real-World Case Studies",
    text: "Great insights into real-world DevOps pipelines and container orchestration."
  },
  {
    name: "Sophia",
    date: "May 20, 2026",
    course: "Microsoft Azure Administrator Training (AZ-104)",
    text: "The labs on Virtual Networks and Active Directory were extremely practical."
  }
];
...
const courses = [
  {
    ...
    duration: "45 hours 0 min",
    desc: "This course prepares individuals to implement, manage, and monitor Microsoft Azure infrastructure, providing the skills necessary to manage Azure environments effectively.",
    tags: ["Azure Active Directory", "Role-Based Access Control", "Subscriptions & Governance", "Storage Configuration"],
    skillsIntro: "Managing Azure AD · Role management and RBAC · Policy and governance configuration · Storage management · VM deployment · Container management"
  },
  {
    no: 2,
    title: "Azure DevOps: Real-World Case Studies",
    duration: "22 Hours",
    desc: "The Azure DevOps: Real-World Case Studies course provides hands-on training in Azure DevOps practices, focusing on Azure Boards, Repos, Containers, Web App Automation, and Kubernetes. It includes practical labs and real-world scenarios to build proficiency.",
    tags: ["Azure Boards", "Azure Repos and GitHub", "Azure Container & Web App Automation", "Azure Kubernetes Services"],
    skillsIntro: "Software Development Lifecycle · Agile Methodology · Sprint Planning · Kanban Management · Git Operations · Continuous Integration and Delivery"
  }
];
...
const faqData = [
  {
    q:"What is the primary focus of the Azure Cloud Engineer Certificate Program?",
    a:"The program focuses on preparing individuals to effectively manage and deploy Azure infrastructure and implement advanced DevOps practices."
  },
  {
    q:"What are the prerequisites for this program?",
    a:"A basic understanding of cloud concepts, experience with the Azure platform, and familiarity with DevOps practices and version control systems."
  }
];
       ...
       <div className="heroContainer">
         ...
         <div className="heroContent">
           ...
           <div className="subHeading">
             <FaCheckCircle />
             <h3>Become a Proficient Azure Cloud Engineer</h3>
           </div>
     
           <p>
             Master the skills needed to manage and deploy robust Azure
             environments and advanced DevOps practices with this comprehensive
             certificate program.
           </p>
     ...
     >
       ...
       <FaUser />
         ...
         <div className="heroImageWrapper">
          ...
          <div> <img
             src={heroImage}
             alt="Azure Cloud Engineer Certificate"
           />
          </div>
         </div>
...
<section id="overview" className="program-overview-section">
  ...
  <p className="overview-text">
    The Azure Cloud Engineer Certificate Program is designed to equip you with the advanced technical skills needed to excel in cloud computing and infrastructure management using Microsoft Azure. This program covers all essential aspects of Azure administration, from foundational concepts to complex infrastructure management and DevOps practices.
  </p>
  ...
  <p className="highlights-description">
    The program consists of two main courses that focus on the core and specialized aspects of Azure. You'll gain hands-on experience through practical labs and real-world case studies, preparing you for a career as an Azure specialist or DevOps engineer.
  </p>
     ...
     <div className="timeline-container">
          ...
          <div className="timeline-step">
            ...
            <div className="timeline-card">
              ...
              <p>Focus on implementing, managing, and monitoring Azure infrastructure.</p>
              <div className="skill-tags">
                <span>Microsoft Azure Administrator Training (AZ-104)</span>
              </div>
            </div>
          </div>
          ...
          <div className="timeline-step">
            ...
            <div className="timeline-card">
              <h4>Core</h4>
              <p>Learn Azure DevOps practices through hands-on training and real-world case studies.</p>
              <div className="skill-tags">
                <span>Azure DevOps: Real-World Case Studies</span>
              </div>
            </div>
          </div>
      ...
      <div className="ph-badges-grid">
         <div className="ph-badge">
                ...
                <div className="ph-badge">
                  ...
                  <span>Azure administration</span>
                </div>
                <div className="ph-badge">
